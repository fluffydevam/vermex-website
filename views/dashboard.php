...
<body class="bg-gray-100 font-sans antialiased text-gray-800 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 custom-sidebar text-white flex flex-col justify-between p-4 flex-shrink-0">
        <div>
            ...
            <nav class="space-y-1">
                <a href="#" class="flex items-center gap-3 px-3 py-2 text-sm text-emerald-100 active-nav font-medium">
                    <i data-lucide="layout-dashboard" class="w-4 h-4 text-emerald-400"></i>
                    Dashboard
                </a>
                <a href="clients.php" class="flex items-center gap-3 px-3 py-2 text-sm text-emerald-300 hover:bg-emerald-900/50 hover:text-white rounded-lg transition">
        ...
        <div>
            <div class="bg-emerald-900/40 p-3 rounded-lg mb-4 border border-emerald-800/40">
                <div class="flex items-center gap-2 text-amber-400 text-xs font-semibold mb-1">
                    <i data-lucide="alert-triangle" class="w-4 h-4"></i>
                    Pending Payment Clearances
                </div>
                <p class="text-[11px] text-emerald-200">4 bookings awaiting 50% downpayment verification before dispatch[cite: 1].</p>
            </div>
